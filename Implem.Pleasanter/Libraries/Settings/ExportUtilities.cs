...
namespace Implem.Pleasanter.Libraries.Settings
{
    public static class ExportUtilities
    {
        ...
        public static Dictionary<string, ControlData> SourceColumnOptions(
            IContext context, SiteSettings ss, Join join, string searchText = null)
        {
        ...
        public static ResponseFile Csv(IContext context, SiteSettings ss, Export export)
        {
        ...
        public static string FileName(IContext context, SiteSettings ss, string name)
        {
        ...
        private static Dictionary<int, string> IssueData(
            IContext context, SiteSettings ss, Export export, IssueModel issueModel)
        {
        ...
        private static Dictionary<int, string> ResultData(
            IContext context, SiteSettings ss, Export export, ResultModel resultModel)
        {
            return export.Columns
                .Where(exportColumn => exportColumn.SiteId == ss.SiteId)
                .ToDictionary(
