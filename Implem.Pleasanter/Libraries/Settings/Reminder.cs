...
namespace Implem.Pleasanter.Libraries.Settings
{
    ...
    public class Reminder : ISettingListItem
    {
        ...
        public void Remind(IContext context, SiteSettings ss, bool test = false)
        {
        ...
        private Title GetSubject(IContext context, bool test)
        {
        ...
        private string GetBody(IContext context, SiteSettings ss, DataSet dataSet)
        {
        ...
        private DataSet GetDataSet(IContext context, SiteSettings ss)
        {
        ...
        private string Relative(IContext context, DateTime time)
        {
        ...
        public Reminder GetRecordingData(IContext context)
        {
        ...
        private string ReplacedLine(IContext context, SiteSettings ss, DataRow dataRow)
        {
            var line = Line;
