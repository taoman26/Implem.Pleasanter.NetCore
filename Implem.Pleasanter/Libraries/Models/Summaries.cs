...
namespace Implem.Pleasanter.Libraries.Models
{
    ...
    {
        public static void Synchronize(IContext context, SiteSettings ss)
        {
            ss.Summaries?.ForEach(summary => Synchronize(
                context: context, ss: ss, summary: summary));
        }

        public static void Synchronize(IContext context, SiteSettings ss, int id)
        {
            var summary = ss.Summaries?.Get(id);
            Synchronize(context: context, ss: ss, summary: summary);
        }

        public static void Synchronize(IContext context, SiteSettings ss, Summary summary)
        {
        ...
        private static IEnumerable<DataRow> IssuesDataRows(
            IContext context,
            SiteSettings ss,
            string destinationColumn,
        ...
        private static IEnumerable<DataRow> ResultsDataRows(
            IContext context,
            SiteSettings ss,
            string destinationColumn,
            IEnumerable<long> destinations,
