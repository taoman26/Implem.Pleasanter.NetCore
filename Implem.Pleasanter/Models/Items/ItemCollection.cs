...
namespace Implem.Pleasanter.Models
{
    ...
    public class ItemCollection : List<ItemModel>
    {
        ...
        public ItemCollection(IContext context, IEnumerable<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private ItemCollection Set(IContext context, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new ItemModel(context, dataRow));
                }
