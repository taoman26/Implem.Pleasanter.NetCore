...
namespace Implem.Pleasanter.Models
{
    ...
    public class BinaryCollection : List<BinaryModel>
    {
        ...
        public BinaryCollection(IContext context, IEnumerable<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private BinaryCollection Set(IContext context, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new BinaryModel(context, dataRow));
                }
