...
namespace Implem.Pleasanter.Models
{
    ...
    public class SearchIndexCollection : List<SearchIndexModel>
    {
        ...
        public SearchIndexCollection(IContext context, IEnumerable<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private SearchIndexCollection Set(IContext context, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new SearchIndexModel(context, dataRow));
                }
