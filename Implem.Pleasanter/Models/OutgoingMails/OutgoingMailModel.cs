...
namespace Implem.Pleasanter.Models
{
    ...
    public class OutgoingMailModel : BaseModel
    {
        ...
        public bool ReferenceVer_Updated(IContext context, Column column = null)
        {
        ...
        public bool OutgoingMailId_Updated(IContext context, Column column = null)
        {
        ...
        public bool Host_Updated(IContext context, Column column = null)
        {
        ...
        public bool Port_Updated(IContext context, Column column = null)
        {
        ...
        public bool From_Updated(IContext context, Column column = null)
        {
        ...
        public bool To_Updated(IContext context, Column column = null)
        {
        ...
        public bool Cc_Updated(IContext context, Column column = null)
        {
        ...
        public bool Bcc_Updated(IContext context, Column column = null)
        {
        ...
        public bool SentTime_Updated(IContext context, Column column = null)
        {
        ...
        public OutgoingMailModel(IContext context, DataRow dataRow, string tableAlias = null)
        {
            OnConstructing(context: context);
            Context = context;
        ...
        public Error.Types Restore(IContext context, long outgoingMailId)
        {
            OutgoingMailId = outgoingMailId;
            Rds.ExecuteNonQuery(
                context: context,
        ...
        /// Fixed:
        /// </summary>
        public OutgoingMailModel(IContext context, string reference, long referenceId)
        {
        ...
        /// Fixed:
        /// </summary>
        public string GetDestinations(IContext context)
        {
        ...
        public Error.Types Send(
            IContext context, SiteSettings ss, List<SqlStatement> additionalStatements = null)
        {
        ...
        /// Fixed:
        /// </summary>
        private void SendBySmtp(IContext context)
        {
            new Smtp(
                context: context,
                host: Host,
        ...
        /// Fixed:
        /// </summary>
        private void SendBySendGrid(IContext context)
        {
            new SendGridMail(
                context: context,
                host: Host,
