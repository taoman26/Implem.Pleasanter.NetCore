...
namespace Implem.Pleasanter.Models
{
    ...
    public class GroupModel : BaseModel
    {
        ...
        public bool GroupName_Updated(IContext context, Column column = null)
        {
        ...
        public GroupModel(IContext context, SiteSettings ss, DataRow dataRow, string tableAlias = null)
        {
            OnConstructing(context: context);
            Context = context;
            TenantId = context.TenantId;
        ...
        public GroupApiModel GetByApi(IContext context, SiteSettings ss)
        {
        ...
        public Error.Types Restore(IContext context, SiteSettings ss,int groupId)
        {
            GroupId = groupId;
            Rds.ExecuteNonQuery(
                context: context,
