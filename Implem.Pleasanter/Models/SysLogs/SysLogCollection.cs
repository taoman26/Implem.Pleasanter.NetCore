...
namespace Implem.Pleasanter.Models
{
    ...
    public class SysLogCollection : List<SysLogModel>
    {
        ...
        public SysLogCollection(IContext context, IEnumerable<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private SysLogCollection Set(IContext context, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new SysLogModel(context, dataRow));
                }
