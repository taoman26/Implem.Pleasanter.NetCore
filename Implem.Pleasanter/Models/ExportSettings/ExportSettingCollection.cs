...
namespace Implem.Pleasanter.Models
{
    ...
    public class ExportSettingCollection : List<ExportSettingModel>
    {
        ...
        public ExportSettingCollection(IContext context, IEnumerable<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private ExportSettingCollection Set(IContext context, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new ExportSettingModel(context, dataRow));
                }
