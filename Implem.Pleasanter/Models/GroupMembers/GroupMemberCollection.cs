...
namespace Implem.Pleasanter.Models
{
    ...
    public class GroupMemberCollection : List<GroupMemberModel>
    {
        ...
        public GroupMemberCollection(IContext context, IEnumerable<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private GroupMemberCollection Set(IContext context, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new GroupMemberModel(context, dataRow));
                }
