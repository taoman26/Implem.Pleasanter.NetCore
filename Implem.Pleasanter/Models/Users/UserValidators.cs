...
namespace Implem.Pleasanter.Models
{
    ...
    {
        public static Error.Types OnEntry(IContext context, SiteSettings ss, bool api = false)
        {
        ...
        public static Error.Types OnReading(IContext context, SiteSettings ss, bool api = false)
        {
            if (api && (context.ContractSettings.Api == false || !Parameters.Api.Enabled))
            {
                return Error.Types.InvalidRequest;
        ...
        public static Error.Types OnEditing(
            IContext context, SiteSettings ss, UserModel userModel, bool api = false)
        {
            if (api && (context.ContractSettings.Api == false || !Parameters.Api.Enabled))
            {
                return Error.Types.InvalidRequest;
        ...
        public static Error.Types OnRestoring(IContext context, bool api = false)
        {
            if (api && (context.ContractSettings.Api == false || !Parameters.Api.Enabled))
            {
                return Error.Types.InvalidRequest;
        ...
        public static Error.Types OnExporting(IContext context, SiteSettings ss, bool api = false)
        {
            if (api && (context.ContractSettings.Api == false || !Parameters.Api.Enabled))
            {
                return Error.Types.InvalidRequest;
        ...
        /// Fixed:
        /// </summary>
        public static Error.Types OnPasswordChanging(IContext context, UserModel userModel)
        {
        ...
        public static Error.Types OnPasswordChangingAtLogin(
            IContext context, UserModel userModel)
        {
            if (!DefinitionAccessor.Parameters.Service.ShowProfiles)
            {
                return Error.Types.InvalidRequest;
        ...
        /// Fixed:
        /// </summary>
        public static Error.Types OnPasswordResetting(IContext context)
        {
            if (!Parameters.Service.ShowProfiles)
            {
                return Error.Types.InvalidRequest;
        ...
        /// Fixed:
        /// </summary>
        public static Error.Types OnApiEditing(IContext context, UserModel userModel)
        {
        ...
        /// Fixed:
        /// </summary>
        public static Error.Types OnApiCreating(IContext context, UserModel userModel)
        {
            if (context.ContractSettings.Api == false || !Parameters.Api.Enabled)
            {
                return Error.Types.InvalidRequest;
        ...
        /// Fixed:
        /// </summary>
        public static Error.Types OnApiDeleting(IContext context, UserModel userModel)
        {
            if (context.ContractSettings.Api == false || !Parameters.Api.Enabled)
            {
                return Error.Types.InvalidRequest;
        ...
        /// Fixed:
        /// </summary>
        public static Error.Types OnSwitchUser(IContext context)
        {
