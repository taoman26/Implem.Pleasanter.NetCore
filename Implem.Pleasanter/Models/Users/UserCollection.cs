...
namespace Implem.Pleasanter.Models
{
    ...
    public class UserCollection : List<UserModel>
    {
        ...
        public UserCollection(IContext context,SiteSettings ss, IEnumerable<DataRow> dataRows)
        {
            Set(context, ss, dataRows);
        }

        private UserCollection Set(IContext context, SiteSettings ss, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new UserModel(context, ss, dataRow));
                }
