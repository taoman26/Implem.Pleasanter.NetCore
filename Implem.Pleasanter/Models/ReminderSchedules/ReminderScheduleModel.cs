...
namespace Implem.Pleasanter.Models
{
    ...
    public class ReminderScheduleModel : BaseModel
    {
        ...
        public bool Id_Updated(IContext context, Column column = null)
        {
            return Id != SavedId &&
                (column == null ||
                column.DefaultInput.IsNullOrEmpty() ||
        ...
        public bool ScheduledTime_Updated(IContext context, Column column = null)
        {
        ...
        public ReminderScheduleModel(IContext context, DataRow dataRow, string tableAlias = null)
        {
